 ...
 * @LastEditors: rendc
 * @LastEditTime: 2025-03-10 22:53:07
 */
...
export default function RootLayout({
  ...
  return (
      <html lang="en">
        ...
        <body
          className={`${geistSans.variable} ${geistMono.variable} overflow-x-hidden antialiased bg-background text-foreground dark:bg-[#1c1817] dark:text-[#e7e5e4]` }
        >
           <NextTopLoader />
          <ThemeProvider
